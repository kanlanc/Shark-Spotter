...
class ComputeLoss:
    def __init__(self, model):
        ...
        self.det = model.model[-1]  # Detect() module
        self.stride = self.det.stride  # model stride [8, 16, 32]
        self.nc = self.det.nc  # number of classes
        self.nl = self.det.nl  # number of detection layers
        self.na = self.det.na  # number of anchors
        self.anchors = self.det.anchors
        ...
        self.BCEcls, self.BCEobj, self.gr = BCEcls, BCEobj, 1
